...
namespace DataLayerLibrary
{
    ...
    public class DBHelper
    {
        ...
        private readonly CommandBuilder _commandBuilder = null;
        private readonly DataAdapterManager _dbAdapterManager;// = new DataAdapterManager();
        private static DBHelper _dbHelper = null;
        //private IDbConnection _connection = null;
        private readonly string _providerName = string.Empty;
        private readonly AssemblyProvider _assemblyProvider = null;
        #endregion
